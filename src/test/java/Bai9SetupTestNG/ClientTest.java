...
public class ClientTest extends BaseTest {
    ...
    @Test(priority = 0, description = "Login to salary")
    public void adminloginSalary() throws InterruptedException {
    ...
    @Test(priority = 1, description = "create permission")
...
//        Thread.sleep(2000);
    ...
    @Test(priority = 2, description = "delete permission")
